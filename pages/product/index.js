                ...
                <Grid container spacing={3}>
                    <Grid item xs={8}>
                        ...
                        <Box className={styles.box} textAlign="left">
                            ...
                            <Typography component="h4" variant="h4" className={styles.productName}>PC Master Race RTX 10090</Typography>
                            <Typography component="h4" variant="h4" className={styles.price}>R$ 1.000.000.000</Typography>
                            <Chip label="Categoria" />
                        </Box>
                        <Box className={styles.box} textAlign="left">
                            <Typography component="h6" variant="h6">Descrição</Typography>
                            <Typography component="p" variant="body2">Em resumo, o Computador de Última Geração Gamer é a escolha perfeita para os jogadores mais exigentes que buscam desempenho máximo, gráficos impressionantes e uma experiência de jogo imersiva. Com seu hardware de ponta, design moderno e recursos avançados, este computador é verdadeiramente uma obra-prima da tecnologia gamer. Prepare-se para mergulhar em um mundo de jogos com qualidade e desempenho incomparáveis!</Typography>
